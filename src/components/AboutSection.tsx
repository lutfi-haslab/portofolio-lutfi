                ...
                <div className="lg:col-span-2">
                    <div className="space-y-6">
                        <p className="text-lg text-gray-300 leading-relaxed">
                            ...
                            college by tinkering with Arduino and C++.
                            Originally trained as an Electrical Engineer, my
                            career shifted gears in 2020 when I decided to focus
                            on web development, especially using Laravel.
                        </p>
                        <p className="text-lg text-gray-300 leading-relaxed">
                            Since joining my current workplace, I wear multiple
                            hats as a researcher and lead developer in Full
                            Stack and Blockchain projects. I'm well-versed in
                            various programming languages and frameworks.
                        </p>
                        <p className="text-lg text-gray-300 leading-relaxed">
                            Right now, I mainly work with Typescript for
                            projects and use Flutter for mobile development.
                            I've also completed a QA Bootcamp at Binar, a
                            well-known institution in Indonesia.
                        </p>
                        <p className="text-lg text-gray-300 leading-relaxed">
                            I'm a perpetual learner, always excited to explore
                            new technologies and expand my skills.
                        </p>
                    </div>
                </div>
