...
export const myProjects: Project[] = [
    {
        ...
        img_url:
            'https://res.cloudinary.com/haslab/image/upload/v1715160549/portofolio/npqsdp7clleogzdal4dl.png',
        tags: ['typescript', 'nextjs', 'ai', 'no-code'],
        detail: 'Web application to create stunning website with AI based on model GPT and Anthropic (Claude) API',
    },
    {
        ...
        detail: 'Web application build with react as frontend and nestjs as backend for prototype Central Bank digital currency, there is 5 website including, Central Bank Suite, Core System Suite, Financial Service Provider, Merchant Suite, and Enterprise Suite',
    },
    {
        ...
        tags: ['typescript', 'blockchain'],
        detail: 'A mobile app wallet build with flutter for end user to send and receive DIDR money from CBDC and stablecoind.',
    },
    {
    ...
    },
    {
        ...
        detail: 'A website platform build with NextJS that work to upload document to the Blockchain and setting up the document format using pdf.js, the output from this file is PDF document with user generated style pdf and qr code.',
    },
    {
        ...
        detail: 'A Mobile app build with Kotlin that work to verify document using OpenCV QR scanner or file picker with Blockchain.',
    },
    {
